...
export class StadiaDatabase {
  ...
  private readonly stadiaModelDefinitions =

  readonly db = zoddb.open(this.path, {});
}
...
const stadiaModelDefinitions = {
  ...
  PlayerSearch: {
    ...
    seedKeys: [..."abcdefghijklmnopqrstuvwxyz"].flatMap((s) =>
      [..."abcdefghijklmnopqrstuvwxyz0123456789"].map((p) => p + s)
    ),
  },
};
...
const ProtoMessage = Proto.array().nullable();
